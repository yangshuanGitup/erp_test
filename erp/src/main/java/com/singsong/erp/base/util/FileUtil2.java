...
public class FileUtil2 {
	...
	ScatterZipOutputStream dirs = ScatterZipOutputStream.fileBased(File.createTempFile("whatever-preffix", ".whatever"));

	public FileUtil2(String rootPath) throws IOException {  
